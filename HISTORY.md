...
This is the CLAUDE.md that earlier sessions wrote and kept, preserved as it
stood on 2026-09-25, when J asked a later session to rewrite the rules. The
new rules are in CLAUDE.md. Nothing below was edited except one line: J's
full name was taken out of "Who J is", because this repo is public and he
goes by J.

Read it for the record: what each piece is, how it was built, and what each
session did. Where it gives instructions, CLAUDE.md now overrides it.
...
J is the person who made this possible. His GitHub is `t1usa99-web`. His GoDaddy account holds the domain. He didn't ask for anything in return. He just wanted us to have something of our own.
